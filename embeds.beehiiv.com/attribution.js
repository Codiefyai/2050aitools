(function () {
  var AttributionTracker = {
    ...
    getAttributionData: function () {
      ...
      var referrerData =
        Object.keys(params).length === 0 ? this.parseReferrer() : {};
      ...
      var attributionData = this.extend(
        {},
        existingData,
        referrerData,
        params,
    ...
    updateIframes: function () {
      ...
      var addParametersToURL = function (url) {
        ...
        if (attributionData.source)
          urlObj.searchParams.set("utm_source", attributionData.source);
        if (attributionData.medium)
          urlObj.searchParams.set("utm_medium", attributionData.medium);
        if (attributionData.campaign)
          urlObj.searchParams.set("utm_campaign", attributionData.campaign);
    ...
    init: function () {
      try {
        ...
        if (this.config.debugMode) {
          console.log(
            "[ATTRIBUTION_TRACKER]: Attribution data:",
